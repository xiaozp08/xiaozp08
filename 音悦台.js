...
async function getMusicSheetResponseById(sheet, page, pagesize = 50) {
    ...
    let play_list = parse_play_list_html(raw_html, separator, bexchange)
    return play_list;
}
...
async function getRecommendSheetTags() {
    ...
    const pinned = [
        ...
        {
            id: "/playtype/jingdian.html",
            title: "经典",
            digest: "fixed",
            sign: "song"
        },
        {
            id: "/playtype/ktv.html",
            title: "KTV",
            digest: "fixed",
            sign: "song"
        },
        {
            ...
            digest: "fixed",
            sign: "song",
            id: "/playtype/fangsong.html",
        },
        {
            title: "安静",
            digest: "fixed",
            id: "/playtype/anjing.html",
            sign: "song"
        },
        {
            title: "90后",
            digest: "fixed",
            id: "/playtype/90h.html",
            sign: "song"
        },
        {
            title: "流行",
            digest: "fixed",
            id: "/playtype/liuxing.html",
            sign: "song"
        },
    ];
    return {
